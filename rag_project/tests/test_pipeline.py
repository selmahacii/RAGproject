...
from src.embeddings import FakeEmbeddings, cosine_similarity
from src.retrieval import ChromaVectorStore, SearchResult, NoopReranker
from src.llm import FakeLLM, Message, MessageRole, RAGPrompts
from src.pipeline import RAGPipeline
from src.eval import EvaluationSample, EvaluationResult, RAGEvaluator
...
def sample_document():
    ...
    return Document(
        content="This is a test document for RAG pipeline testing. "
...
def fake_llm():
    ...
    return FakeLLM(responses=["Test response from fake LLM."])
...
class TestRetrieval:
    ...
    def test_vector_store_add_and_search(
        ...
        # Search
        query_embedding = fake_embeddings.embed_query("What is RAG?")
...
class TestLLM:
    ...
    def test_rag_prompts(self):
        """Test RAG prompt generation."""
        system, user = RAGPrompts.get_rag_prompt(
...
class TestPipeline:
    ...
    def test_pipeline_query(self, test_pipeline):
        ...
        # Query
        response = test_pipeline.query("What is RAG?")
...
class TestEvaluation:
    ...
    def test_evaluator_heuristic(self, test_pipeline):
        ...
        evaluator = RAGEvaluator(test_pipeline, use_ragas=False)
...
class TestIntegration:
    ...
    def test_end_to_end_rag(self, test_pipeline):
