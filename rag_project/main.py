...
logger.add(
    "logs/rag_pipeline_{time:YYYY-MM-DD}.log",
    rotation="1 day",
    retention="7 days",
...
def run_rag_pipeline(
    ...
    """
    Run the complete RAG pipeline with a single function call.
    ...
    Example:
        >>> result = run_rag_pipeline("What is RAG?", data_folder="./docs")
        >>> print(result["answer"])
    ...
    Example output:
        ...
        knowledge base and uses them as context for the LLM to generate
        accurate answers.
        
        ─────────────────────────────────────────────────────────────
        Sources (3):
          [1] rag_intro.pdf (Score: 0.892)
    ...
    from src.embeddings import get_embeddings, build_vectorstore, get_or_create_vectorstore
    ...
    # =========================================================
    # STEP 5: Generate answer with GLM
    # =========================================================
    step_start = time.time()
...
def print_result_summary(result: dict[str, Any]) -> None:
    """Print a formatted summary of the RAG result."""
...
def interactive_mode():
    """Run RAG pipeline in interactive Q&A mode."""
    print("\n" + "╔" + "═" * 58 + "╗")
    print("║" + " " * 15 + "🔍 RAG Pipeline Interactive Mode" + " " * 12 + "║")
    print("╚" + "═" * 58 + "╝")
    ...
    try:
        from src.ingestion import load_pdfs
        from src.chunking import recursive_chunk
        from src.embeddings import get_embeddings, build_vectorstore
        from src.retrieval import retrieve_and_rerank
        from src.llm import generate_answer
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="RAG Pipeline - Ask questions about your documents"
    )
    parser.add_argument(
        "question",
        nargs="?",
